  ...
  75                     ; 43 }
  78  0016 81            	ret
 102                     ; 45 void PWM_Output_Control(){
 103                     	switch	.text
 104  0017               _PWM_Output_Control:
 108                     ; 47   TIM3_OC1Init(TIM3_OCMode_PWM1, TIM3_OutputState_Enable, 0, TIM3_OCPolarity_High, TIM3_OCIdleState_Reset);
 ...
 250                     ; 73 }
 253  0058 81            	ret
 266                     	xdef	_PWM_Output_Control
 267                     	xdef	_SYS_Delay_NOP
 268                     	xdef	_SYSCTRL_Timer
